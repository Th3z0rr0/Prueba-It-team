...
<body>
    ...
    <div class="container">
        ...
        <form action="../../logica/guardarDatos.php" id="formU" class="rounded shadow-lg" method="POST">
            ...
            <input type="number" class="form-control mb-2" name="numero" required>

            <label for="nombres">Nombres:</label>
            <input type="text" class="form-control mb-2" name="nombres" required>

            <label for="apellidos">Apellidos:</label>
            <input type="text" class="form-control mb-2" name="apellidos" required>

            <label for="edad">Edad:</label>
            <input type="number" class="form-control mb-2" name="edad" required>
